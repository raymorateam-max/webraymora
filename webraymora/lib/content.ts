...
export const fallbackCopy = {
  hero: {
    title: "Web development. Built properly.",
    subtitle:
      "Fast, high-converting websites — designed, built, and shipped with clear pricing and a proven process. Graphic design, video, and copy join the roster soon.",
  },
  servicesIntro:
